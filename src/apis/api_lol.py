    ...
    for match_id in matchId:
        ...
        if match.status_code == 200:
            ...
            for sumName in match_det['info']['participants']:
                ...
                del sumName['nexusLost']
                del sumName['nexusKills']
                del sumName['nexusTakedowns']
                del sumName['item0']
                del sumName['item1']
                del sumName['item2']
                del sumName['item3']
                ...
                del sumName['item5']
                del sumName['item6']
                del sumName['spell1Casts']
                del sumName['spell2Casts']
                del sumName['spell3Casts']
                del sumName['spell4Casts']
